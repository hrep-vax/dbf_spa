    ...
    <ValidationObserver ref="profileForm">
      <div>
        <div class="grid grid-cols-3 gap-6 mb-4 sm:mb-0">
          <label for="profile-first-name" class="text-sm font-medium text-message my-auto"> Voucher* </label>
          <div class="col-span-2">
            <app-text-input v-model="voucher" name="voucher" rules="required|max:255" id="voucher"/>
          </div>
        </div>
        <div class="hidden sm:block" aria-hidden="true">
          <div class="py-5">
        ...
        <div class="grid grid-cols-3 gap-6 mb-4 sm:mb-0">
          <label for="profile-last-name" class="text-sm font-medium text-message my-auto"> Check* </label>

          <div class="col-span-2">
            <app-text-input v-model="check" name="check" rules="required|max:255" id="check"/>
          </div>
        </div>
        <div class="hidden sm:block" aria-hidden="true">
          <div class="py-5">
        ...
        <div class="grid grid-cols-3 gap-6 mb-4 sm:mb-0">
          <label for="profile-middle-name" class="text-sm font-medium text-message my-auto"> Code* </label>

          <div class="col-span-2">
            <app-text-input v-model="code" name="code" rules="max:255" id="code"/>
          </div>
        </div>
        ...
        <div class="grid grid-cols-3 gap-6 mb-4 sm:mb-0">
          <label for="profile-home-address" class="text-sm font-medium text-message my-auto"> Amount*</label>
