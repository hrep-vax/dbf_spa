        ...
        <div class="grid grid-cols-3 gap-6">
            ...
            <div class="col-span-2 ">
                <div class="flex items-center">
                    ...
                    <label for="upload_file" refs="upload_file" class="ml-5 bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        Change
                    </label>
                </div>
            </div>
